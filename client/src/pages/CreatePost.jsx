  ...
  return (
   <section className='max-w-7xl mx-auto'>
    ...
    <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
      ...
      text-gray-900 text-sm rounded-lg fous:ring-blue-500 
      foucs:border-blue-500 w-64 p-3 h-64 flex justify-center items-center'>
        {
          form.photo ? (
            <img src={form.photo} alt={form.prompt} className='w-full h-full object-contain opacity-40' />
          ):(
              <img 
              src={preview}
              alt='preview'
